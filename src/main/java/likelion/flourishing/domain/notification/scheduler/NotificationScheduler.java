...
/**
 * 매일 17시 30분(Asia/Seoul) 알림 발송 트리거.
 *
 * <p>JVM 기본 시간대를 UTC로 고정해 두었으므로 zone을 반드시 지정한다. 지정하지 않으면
 * 한국 시간 새벽 2시 30분에 돌아간다.
 *
...
public class NotificationScheduler {
    ...
    public void dispatchDailyNotifications() {
        try {
            notificationDispatchService.dispatchToday();
